...
NUM_EPOCHS = 50
BATCH_SIZE = 32
IMAGE_DATASET = "/home/m433788/Thesis/data_asli/6_subregion_overlapping/asli"
...
train_generator_1 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_train_1.csv')
val_generator_1 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_val_1.csv')
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_1.hdf5',
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_overlapping_1.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_overlapping_1.png')
plt.close()
...
train_generator_2 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_train_2.csv')
val_generator_2 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_val_2.csv')
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_2.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_overlapping_2.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_overlapping_2.png')
plt.close()
...
train_generator_3 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_train_3.csv')
val_generator_3 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_val_3.csv')
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_3.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_overlapping_3.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_overlapping_3.png')
plt.close()
...
train_generator_4 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_train_4.csv')
val_generator_4 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_val_4.csv')
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_4.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_overlapping_4.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_overlapping_4.png')
plt.close()
...
train_generator_5 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_train_5.csv')
val_generator_5 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_val_5.csv')
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_5.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_overlapping_5.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_overlapping_5.png')
plt.close()
...
train_generator_6 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_train_6.csv')
val_generator_6 = image_triple_generator(
	'/home/m433788/Thesis/data_asli/CSV/6SR_val_6.csv')
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_6.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_overlapping_6.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_overlapping_6.png')
plt.close()
