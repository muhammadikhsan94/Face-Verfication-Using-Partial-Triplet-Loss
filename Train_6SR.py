...
NUM_EPOCHS = 50
BATCH_SIZE = 32
IMAGE_DATASET = "/home/m433788/Thesis/data_asli/6_subregion/asli"
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_1.hdf5',
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_1.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_1.png')
plt.close()
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_2.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_2.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_2.png')
plt.close()
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_3.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_3.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_3.png')
plt.close()
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_4.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_4.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_4.png')
plt.close()
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_5.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_5.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_5.png')
plt.close()
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_6.hdf5',
                           verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_6SR_6.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_6SR_6.png')
plt.close()
