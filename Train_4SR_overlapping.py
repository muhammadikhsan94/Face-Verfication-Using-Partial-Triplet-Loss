...
NUM_EPOCHS = 50
BATCH_SIZE = 32
IMAGE_DATASET = "/home/m433788/Thesis/data_asli/4_subregion_overlapping/asli"
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_4SR_overlapping_1.hdf5',
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_4SR_overlapping_1.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_4SR_overlapping_1.png')
plt.close()
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_4SR_overlapping_2.hdf5',
						   verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_4SR_overlapping_2.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_4SR_overlapping_2.png')
plt.close()
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_4SR_overlapping_3.hdf5',
						   verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_4SR_overlapping_3.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_4SR_overlapping_3.png')
plt.close()
...
mcp_save = ModelCheckpoint('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_4SR_overlapping_4.hdf5',
						   verbose=1, monitor='val_accuracy', save_best_only=True, mode='max')
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_accuracy_pelatihan_4SR_overlapping_4.png')
plt.close()
...
plt.show()
plt.savefig(
	'/home/m433788/Thesis/Baru/hapus/model_loss_pelatihan_4SR_overlapping_4.png')
plt.close()
