...
#DEFINE LOAD MODEL
model_1 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_1.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_2 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_2.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_3 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_3.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_4 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_4.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_5 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_5.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
model_6 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_overlapping_6.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
...
#EVALUATE
def evaluate():
	ytest, ytest_, ytest_1, ytest_2, ytest_3, ytest_4, ytest_5, ytest_6 = [], [], [], [], [], [], [], []

	#GET GENERATOR
	pair_generator_1 = image_triple_generator(
		'/home/m433788/Thesis/data_asli/CSV/6SR_test_1.csv')
	pair_generator_2 = image_triple_generator(
		'/home/m433788/Thesis/data_asli/CSV/6SR_test_2.csv')
	pair_generator_3 = image_triple_generator(
		'/home/m433788/Thesis/data_asli/CSV/6SR_test_3.csv')
	pair_generator_4 = image_triple_generator(
		'/home/m433788/Thesis/data_asli/CSV/6SR_test_4.csv')
	pair_generator_5 = image_triple_generator(
		'/home/m433788/Thesis/data_asli/CSV/6SR_test_5.csv')
	pair_generator_6 = image_triple_generator(
		'/home/m433788/Thesis/data_asli/CSV/6SR_test_6.csv')
	num_test_steps = NUM_PAIRS // BATCH_SIZE
	curr_test_steps = 0

	for index, (([X1_1, X2_1], Ytest), ([X1_2, X2_2], y), ([X1_3, X2_3], y), ([X1_4, X2_4], y), ([X1_5, X2_5], y), ([X1_6, X2_6], y)) in enumerate(zip(pair_generator_1, pair_generator_2, pair_generator_3, pair_generator_4, pair_generator_5, pair_generator_6)):
	...
	for i in range(len(ytest)):
		ypred = (ytest_3[i] + ytest_4[i]) / 2
		ytest_.append(ypred)

	#Get ROC-Curve
	tpr, fpr, th = roc_curve(ytest, ytest_4)
...
plt.plot(fpr, tpr, 'g', label='AUC %s = %0.2f' %
         ('Model 6 Subregion + Overlapping', roc_auc))
plt.plot([0, 1], [0, 1], 'r--')
...
plt.title('ROC Curve')
plt.savefig(
	'/home/m433788/Thesis/Baru/pengujian/roc_curve_6_subregion_overlapping.jpg')

with open('AUC_Pengujian_6_Subregion_Overlapping.csv', 'w', newline='') as file:
	writer = csv.writer(file, delimiter='@')
	writer.writerow(["model", "fpr", "tpr"])
	for i in range(len(tpr)):
		writer.writerow(["6_subregion_overlapping", fpr[i], tpr[i]])
