...
#DEFINE LOAD MODEL
model_1 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_1.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_2 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_2.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_3 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_3.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_4 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_4.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_5 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_5.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
model_6 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_6SR_6.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
...
def evaluate():
	...
	for i in range(len(ytest)):
		ypred = (ytest_1[i] + ytest_2[i] + ytest_3[i] + ytest_4[i] + ytest_5[i] + ytest_6[i]) / 6
		ytest2.append(ypred)
...
plt.title('ROC Curve')
plt.savefig(
	'/home/m433788/Thesis/Baru/pengujian/roc_curve_6_subregion.jpg')

with open('AUC_Pengujian_6_Subregion.csv', 'w', newline='') as file:
	writer = csv.writer(file, delimiter='@')
	writer.writerow(["model", "fpr", "tpr"])
	for i in range(len(tpr)):
		writer.writerow(["6_subregion", fpr[i], tpr[i]])
