...
#DEFINE LOAD MODEL
model_1 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_1.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_2 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_2.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_3 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_3.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_4 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_4.hdf5',
					 custom_objects={'triplet_loss': triplet_loss})
model_5 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_5.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
model_6 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_6.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
model_7 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_7.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
model_8 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_8.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
model_9 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_9SR_9.hdf5',
                                     custom_objects={'triplet_loss': triplet_loss})
...
plt.title('ROC Curve')
plt.savefig(
	'/home/m433788/Thesis/Baru/pengujian/roc_curve_9_subregion.jpg')

with open('AUC_Pengujian_9_Subregion.csv', 'w', newline='') as file:
	writer = csv.writer(file, delimiter='@')
	writer.writerow(["model", "fpr", "tpr"])
	for i in range(len(tpr)):
		writer.writerow(["9_subregion", fpr[i], tpr[i]])
