...
#DEFINE LOAD MODEL
model_1 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_4SR_overlapping_1.hdf5',
                     custom_objects={'triplet_loss': triplet_loss})
model_2 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_4SR_overlapping_2.hdf5',
                     custom_objects={'triplet_loss': triplet_loss})
model_3 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_4SR_overlapping_3.hdf5',
                     custom_objects={'triplet_loss': triplet_loss})
model_4 = load_model('/home/m433788/Thesis/Baru/hapus/weights_model_pelatihan_4SR_overlapping_4.hdf5',
                     custom_objects={'triplet_loss': triplet_loss})
...
def evaluate():
	ytest, ytest_, ytest_1, ytest_2, ytest_3, ytest_4 = [], [], [], [], [], []
	s = []
...
plt.plot(fpr, tpr, 'g', label='AUC %s = %0.2f' %
         ('Model 4 Subregion Overlapping', roc_auc))
plt.plot([0, 1], [0, 1], 'r--')
plt.legend(loc='lower right')
plt.ylabel('True Positive Rate')
plt.xlabel('False Positive Rate')
plt.title('ROC Curve')
plt.savefig('/home/m433788/Thesis/Baru/pengujian/roc_curve_4_subregion_overlapping.jpg')

with open('AUC_Pengujian_4_Subregion_Overlapping.csv', 'w', newline='') as file:
